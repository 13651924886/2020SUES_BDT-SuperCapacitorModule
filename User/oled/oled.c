...
void OLED_Task(void)
{
	//			//OLED_ShowString(0,0,"ChargeOn!",16);
//			sprintf(print_temp,"ADC_Value= %2.2f ",ADC_ConvertedValueLocal[0]);
//			OLED_ShowString(0,0,print_temp,16);
	//			//OLED_ShowString(0,5,"DischargeOn!",16);		
//			sprintf(print_temp,"ADC_Value= %2.2f ",ADC_ConvertedValueLocal[0]);
//			OLED_ShowString(0,0,print_temp,16);
			//OLED_ShowString(0,5,"Kiss My Ass",16);
//		OLED_ShowCHinese(16,3,0);
//		OLED_ShowCHinese(32,3,1);
//		OLED_ShowCHinese(48,3,2);
//		OLED_ShowChar(64,3,'K',16);
//		delay_ms(1000);	
		//OLED_DrawBMP(80, 1,128, 7,BT_BPM);
}
