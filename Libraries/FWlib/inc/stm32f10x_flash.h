...
#define FLASH_WRProt_Pageint16_tto19       ((uint32_t)0x00000010) /*!< STM32 Low and Medium density devices: Write protection of page 16 to 19 */
...
#define FLASH_WRProt_Pageint16_tto17       ((uint32_t)0x00000100) /*!< STM32 High-density, XL-density and Connectivity line devices:
